...
public struct Birthday: Hashable, Codable, Sendable, CustomStringConvertible {
	...
	public var description: String {
		String(format: "%02d.%02d.%04d", locale: Locale(identifier: "en_US_POSIX"), day, month, year)
	}
	...
	public init(from decoder: any Decoder) throws {
		...
		let components = try container.decode(String.self).split(separator: ".")
		let error = "Invalid date, expected format DD.MM.YYYY"
