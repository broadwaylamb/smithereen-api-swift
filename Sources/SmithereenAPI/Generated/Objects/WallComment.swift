...
/// A comment under a post on a wall.
public struct WallComment: WallPostProtocol, CommentProtocol, Identifiable {
	...
	public var thread: CommentThread<WallComment>?
	...
	public init(
		...
		thread: CommentThread<WallComment>? = nil,
