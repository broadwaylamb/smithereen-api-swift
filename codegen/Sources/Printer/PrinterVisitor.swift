...
final class PrinterVisitor {
	...
	func printFile(_ def: FileDef) -> SourceFileSyntax {
		print("Generating \(def.path)")
		return SourceFileSyntax(
			leadingTrivia: [
				.lineComment("// This file is automatically generated. DO NOT EDIT!"),
				.newlines(1),
				.lineComment("// Generated from: \(def.schemaPath.trimmingPrefix(rootPath + "/"))"),
				.newlines(2)
			]
		) {
			ImportDeclSyntax(
